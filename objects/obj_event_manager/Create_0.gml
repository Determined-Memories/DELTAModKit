...
init_trophies = function() {
    ...
    if (!variable_global_exists("trophy_data")) global.trophy_data = [];
    
    if (!variable_global_exists("trophies")) global.trophies = [];
...
trigger_event = function(arg0, arg1, arg2 = "n/a") {
    switch (arg0) {
        case EventManagerTriggerTypes.GiveTrophy:
        ...
        case EventManagerTriggerTypes.PostActivity:
