if (os_type == os_windows || os_type == os_linux || os_type == os_macosx){
    ...
    if (controllerUpdate != -1)
    {
        ...
        if (gamepad_get_guid(gamepad_id) == "4c05e60c000000000000504944564944"){ // See someone on the Team really wanted their Mapping Hardcoded for one specific controller
